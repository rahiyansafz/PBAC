...
public class MenuItemsController : ControllerBase
{
    ...
    // GET: api/menuitems/toplevel
        ...
        public async Task<IActionResult> DeleteMenuItem(int id)
        {
            ...
            if (children.Any())
            {
                return BadRequest("Cannot delete a menu item with children. Delete children first or reassign them to another parent.");
            }
    ...
    public class MenuItemCreateDto
    {
        ...
        [StringLength(50)]
        public string RequiredPermissionSystemName { get; set; } = string.Empty;
    }
